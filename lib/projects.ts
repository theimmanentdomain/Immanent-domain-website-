...
export const projects: Project[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "The project is organized around a simple premise: that the present moment is the only place anything actually happens, and that most of contemporary life is designed to prevent access to it.",
      "Details forthcoming.",
    ],
